...
module.exports = (function() {
    ...
    burndown.create = (element, project_name, sprint_id, range_start_date, range_end_date, sprint_end_date, locales) => {
        d3.json(`data/sprint_burndown/${project_name}/sprint_burndown.${sprint_id}.json`, (error, data) => {
            if (error || !data) {
            ...
            var lines = accumulatedData.filter(element => element.color === colorScheme[dataColor]);
