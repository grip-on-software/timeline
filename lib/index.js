...
const colors = d3.scale.ordinal().domain(types.map((spec) => spec.name)).range(["rgb(0, 109, 219", "rgb(73, 0, 146)", "#DB6D00", "rgb(146, 0, 0)", "rgb(182, 109, 255)", "rgb(0, 146, 146)", "rgb(255, 109, 182)", "#777"]);
